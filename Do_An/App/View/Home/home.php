...
<div id="container">
    ...
    <section id="product">
        ...
        <div class="pro-container">
            ...
            <a href="index.php?action=product&category_id=1" class="pro">
        ...
        <div class="pro-container">
            ...
            <a href="index.php?action=product&category_id=2" class="pro">
                <img style="opacity: 0.3;" src="Public/img/see_more.jpeg" alt="">
            </a>
        </div>
        ...
        <div class="pro-container">
            ...
            <a href="index.php?action=product&category_id=3" class="pro">
                <img style="opacity: 0.3;" src="Public/img/see_more.jpeg" alt="">
            </a>
        </div>
        ...
        <div class="pro-container">
            ...
            <a href="index.php?action=product&category_id=4" class="pro">
                <img style="opacity: 0.3;" src="Public/img/see_more.jpeg" alt="">
            </a>
        </div>
